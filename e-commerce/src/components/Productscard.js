      ...
      <div className="container m-auto ml-[10rem]  max-w-screen-lg">
        <div className="flex flex-row pt-12">
          <div className="relative">
            <img src="./img/card-cover-5.jpg" className="flex h-[35rem] w-[32rem]"></img>
          ...
          <div className="flex flex-col ml-8 items-start">
            ...
            {data.map((item, index) => (
              <div key={index} className="flex flex-col text-center w-[11rem] mb-8">
                <img className="w-[11rem] h-[10rem]" src={item.image} alt="" />
                <h5 className="text-[#252B42] font-bold">Graphic Design</h5>
                <a className="text-[#737373] font-bold" href="#">English Department</a>
